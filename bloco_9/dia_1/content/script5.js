...
// Complete a função getUser de forma que ela receba uma outra função como parâmetro para que possa realizar
...
const getUser = (userFullName, userNationality) => {
  ...
  if (userFullName) return userFullName(userToReturn);
  if (userNationality) return userNationality(userNationality);
};
