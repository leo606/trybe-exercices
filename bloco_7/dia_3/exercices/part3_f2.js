...
assert.strictEqual(typeof removeVowels, 'function', 'removeVowels isnt a function');
assert.strictEqual(removeVowels(parameter), result, 'removeVowels doesnt return right')
assert.strictEqual(parameter, 'Dayane', 'parameter has been changed')
